        ...
        if message is not None:
            match message["type"]:
                case "session.created":
                    ...
                    print(session)
                    self.bankFunctions.init_session(session["id"])
                    client_ws.set_cookie("openai-session", session["id"])
                ...
                case "response.output_item.done":
                    if "item" in message and message["item"]["type"] == "function_call":
                        sessionIdFromCookie = client_ws.cookies.get("openai-session")
                        if sessionIdFromCookie is None:
                            print("No session cookie found")
                        else:   
                            print(sessionIdFromCookie.value)
                        ...
                        args["session_id"] = sessionIdFromCookie.value
